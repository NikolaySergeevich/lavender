...
if ($offer_context['offer_type'] === 'special_offer_consultation') {
    ...
    if (in_array('early_booking_gift', $available_types, true)) {
        $lines[] = '— декор до 100 BYN при бронировании минимум за 7 дней;';
    }
    ...
    if (
        ...
        $lines[] = 'Условие 7 дней не выполнено — проверить комплексное предложение или условия на свободную дату.';
    }
    if (
    ...
    if ($offer_context['offer_type'] === 'early_booking_gift') {
        add_line(
            ...
            $offer_context['early_booking_eligible'] === 'yes'
                ...
                : 'До мероприятия меньше 7 дней; проверить доступные варианты и возможные специальные условия'
        );
    }
}
